...
const MainSidear = () => {
  return (
    <div className="flex flex-col  items-center space-y-3 py-24 ">
      <div className="rounded-md z-10   -mb-40">
        <img className="rounded-lg w-48" src={person} alt="" />
      </div>
      <div className="text-center  bg-white dark:bg-my-dark dark:text-white p-6 rounded-xl ">
        <h1 className="text-2xl mt-36 text-gray-800 font-bold dark:text-white dark:mb-2">Abdullah Bin Ziad</h1>
        <div className="dark:bg-my-dark-btn rounded-md w-fit mx-auto px-8 py-2 ">
          <h3 className="text-xl dark:text-my-dark-txt ">
            Full Stack Engineer
          </h3>
        </div>
        <div className="flex  justify-center gap-3 mt-4">
          <NavLink className="p-3  text-blue-700 hover:text-white bg-my-gray dark:bg-my-dark-btn rounded-md hover:bg-btn-grad">
            {" "}
          ...
          <NavLink className="p-3  text-red-700 hover:text-white bg-my-gray dark:bg-my-dark-btn rounded-md hover:bg-btn-grad">
            {" "}
            <FaWeebly className="" />{" "}
          </NavLink>
          <NavLink className="p-3  text-blue-700 hover:text-white bg-my-gray dark:bg-my-dark-btn rounded-md hover:bg-btn-grad">
        ...
        <div className="bg-my-gray dark:bg-my-dark-btn p-3 my-6  rounded-lg">
        ...
        <a href="https://drive.google.com/file/d/12VdgXmHtHr6zODGZVojuCuBq8S7LLEyw/view?usp=drive_link">
          <button className=" w-3/4 mx-auto bg-btn-grad flex gap-3 px-6 py-3 text-white justify-center items-center text-center rounded-2xl">
